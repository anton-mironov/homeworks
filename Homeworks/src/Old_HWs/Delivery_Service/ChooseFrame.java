...
public class ChooseFrame extends JFrame {
    ...
    public ChooseFrame(int inputWeight) {
        ...
        JButton bSend = new JButton("Print bill");
        add(bSend);
    ...
    private void setupTransportDetails(int inputWeight, TransportType chosenTransportType, String chosenCity1, String chosenCity2) {
        ...
        System.out.println("ID of your parsel: No" + generateNumNakladnoj(14));
    }

    public static BigInteger generateNumNakladnoj(int length) {
        Random r = new Random();
